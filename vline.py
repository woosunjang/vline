...
def vline_plotter(args):
    ...
    with open(args.input, "r") as data:
        ...
        with open(outname, "w") as out:
            out.write("IGOR\n")
            out.write("WAVES/D " + direction + "_" + system_name + " " + direction + "_" + system_name + "_locpot\n")
            out.write("BEGIN\n")
...
"""
            ...
            out.write("X Display " + direction + "_" + system_name + "_locpot" + " vs " + direction + "_" + system_name
                      + " as " + '"' + direction + "_" + system_name + "_locpot" + '"' + "\n")
            out.write(preset)
